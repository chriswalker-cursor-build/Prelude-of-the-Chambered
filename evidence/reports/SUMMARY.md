...
| Modern (S3 + V1–V4 + S4 + tuning/dev fixes) | `292e120` | 46 passed, 0 failed | `modern/ant-test.txt` |

Drift check: every PASS/FAIL line from the baseline run appears verbatim in the modern run (`comm -23` over sorted test outcomes = **0 lines**). The 23 additional modern tests are the V1–V4 slice suites plus the dev-spawn utility tests added on the train.
