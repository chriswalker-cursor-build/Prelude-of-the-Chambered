...
import com.mojang.escape.world.block.*;
import com.mojang.escape.ui.GotLootMenu;
...
public abstract class Level {
	...
	private static Level byName(String name) {
		try {
			...
			return (Level) Class.forName("com.mojang.escape.world." + name + "Level").getDeclaredConstructor().newInstance();
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	}
